  ...
  return <>
    ...
    <Link href="/prodotti" className="group mt-5 block">
      <Card className="flex items-center gap-4 p-5 transition duration-300 group-hover:border-amber-300/20">
        ...
        <span className="min-w-0 flex-1"><span className="block font-medium">Prodotti</span><span className="mt-1 block text-xs text-zinc-500">Scopri la selezione Mottola&apos;s Family</span></span>
    ...
    {config.data && <Card className="mt-5 overflow-hidden p-0">
      <div className="flex items-center gap-4 p-5">
        <span className="relative grid size-16 shrink-0 place-items-center overflow-hidden rounded-full bg-white shadow-[0_8px_25px_rgba(0,0,0,.3)] ring-1 ring-white/20">
          <Image src="/logo-mottola-dark.png" alt="Logo Mottola's Family" fill sizes="64px" className="object-contain p-1" />
        </span>
        <div className="min-w-0">
          <p className="text-[10px] font-semibold uppercase tracking-[.2em] text-amber-300">Il tuo barber shop</p>
          <h2 className="mt-1 text-lg font-semibold">Mottola&apos;s Family</h2>
