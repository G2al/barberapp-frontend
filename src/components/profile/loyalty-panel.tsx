...
import { Gift, Scissors, Sparkles, Wifi } from "lucide-react";
...
export function LoyaltyPanel() {
  ...
  return <div className="mt-4">
    <motion.section whileHover={{ y: -2 }} className="relative overflow-hidden rounded-[1.75rem] border border-amber-200/20 bg-[#171612] p-5 shadow-[0_24px_70px_rgba(0,0,0,.42)]">
